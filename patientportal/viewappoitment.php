...
<head>
    ...
    <title><?php "My Appointment"  ?></title>
</head>
...
<div class="container mt-4">
    <div class="row">
        <div class="col-md-12">
            <h1 class="text-center">Hello <?php echo $userRow['first_name'] ?></h1>
        </div>
    </div>
    <div class="row">
        <div class="col-md-3">
            <img src="" class="img-fluid rounded" alt="Your Picture">
        </div>
        <div class="col-md-9">
