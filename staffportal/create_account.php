...
<div class="container mt-3" id="main-content">
    <form action="create_account.php" method="POST" class="ps-3 pe-3 mt-3" style="background-color: #05445e; border-radius: 20px;">
        <div class="fs-3 mt-3 text-light text-center">Register As Staff</div>
